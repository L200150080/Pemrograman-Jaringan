...
print ("Pencarian Data Forlap Informatika tahun 2017 Semester Ganjil")
print ("Tidak Semua nim Masuk dalam data ini")

nim = input("Masukkan NIM anda(format: L200150080) : ")
